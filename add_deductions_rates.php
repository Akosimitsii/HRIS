...
<body>
      ...
      <form name="form1" id="form1" method="post" enctype="multipart/form-data" onSubmit="return validateMe(this.lname.value);" >
        ...
        <h1><a href="index.php"></a>Add Deductions Rates </h1>
