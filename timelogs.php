...
if (!isset ($_GET['page']) ) {  
 ...
 $getQuery = "SELECT * from time_logs_2 ORDER by time_in DESC, lname ASC ";  
 // get the result
 ...
 $getQuery = "SELECT * FROM time_logs_2 ORDER by time_in DESC, lname ASC LIMIT " . $initial_page . ',' . $limit;  
 $result = mysqli_query($conn, $getQuery);      
...
if($variable2 =="") {
  $sql25 = "SELECT * from time_logs_2 ORDER by time_in DESC, lname ASC ";
...
//$row2 = mysqli_fetch_assoc($result);
 ...
 //if($criteria2 == "description") {
   $sql27 = "SELECT * from time_logs_2 where $criteria2 LIKE '$variable2%%' ORDER by time_in DESC, lname ASC " ;
...
if(isset($_POST['Submit2'])) 
{
 ...
 //  $sql27 = "SELECT * from time_logs_2 where emp_num = '$variable1' ORDER by time_in DESC, lname ASC " ;
   $sql27 = "SELECT * from time_logs_2 where qr_code = '$variable1' AND date(login_date) >= '$date1' AND date(login_date) <= '$date2' ORDER by time_in DESC, lname ASC " ;
   $result = mysqli_query($conn, $sql27);
 //$row2 = mysqli_fetch_assoc($result);
 }
}
...
{
 //if($criteria2 == "description") {
   $sql28 = "SELECT * from time_logs_2 ORDER by time_in DESC, lname ASC " ;
