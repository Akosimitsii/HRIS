...
$sql6 = " SELECT * from employees where qr_code = '' order by lname ASC ";
...
$sql7 = " UPDATE employees set qr_code = '$qr_name' where email = '$ename ' ";
$result7 = mysqli_query($conn, $sql7) ; 

$sql8 = " UPDATE qr_codes set qr_image = '$qr_name' where email = '$ename ' ";
